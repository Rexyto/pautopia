...
export default function Conceptos() {
  ...
  const generateQuestion = () => {
    // CRÍTICO: Limpiar la respuesta seleccionada antes de generar nueva pregunta
  ...
  const restartGame = () => {
    // Limpiar la respuesta seleccionada primero
    setSelectedAnswer(null);
          ...
          <div className="conceptos-modal-overlay">
            <div className="conceptos-modal success">
              ...
              <div className="conceptos-modal-buttons">
                <button
                  className="conceptos-button primary"
                  onClick={restartGame}
                >
                  Volver a intentar
                </button>
                <button
                  className="conceptos-button secondary"
                  onClick={() => navigate('/examinate/historia')}
                >
                  Salir
                </button>
              </div>
