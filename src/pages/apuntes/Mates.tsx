      ...
      <main className="biblioteca-content container">
        <div className="biblioteca-header">
          ...
          <p className="biblioteca-subtitle">
            Apuntes y recursos de estudio para 2º de Bachillerato
          </p>
        ...
        <div className="lengua-sections">
          ...
          <section className="lengua-section">
            <h3 className="section-category-title">Probabilidad</h3>
            <div className="resource-cards-grid">
              <div className="resource-card">
                <div className="resource-card-header">
                  <h4 className="resource-card-title">Probabilidad</h4>
                </div>
                <button
                  onClick={() => downloadFile('/mates-probabilidad.pdf')}
          ...
          {/* DERIVADAS */}
          <section className="lengua-section">
            <h3 className="section-category-title">Derivadas</h3>
            <div className="resource-cards-grid">
              <div className="resource-card">
                <div className="resource-card-header">
                  <h4 className="resource-card-title">Tabla de Derivadas</h4>
                </div>
                <button
                  onClick={() => downloadFile('/mates-derivadas.pdf')}
                  className="resource-download-button"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
          ...
          {/* INTEGRALES */}
          <section className="lengua-section">
            <h3 className="section-category-title">Integrales</h3>
            <div className="resource-cards-grid">
              <div className="resource-card">
                <div className="resource-card-header">
                  <h4 className="resource-card-title">Tabla de Integrales Inmediatas</h4>
                </div>
                <button
                  onClick={() => downloadFile('/mates-integrales.pdf')}
                  className="resource-download-button"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
