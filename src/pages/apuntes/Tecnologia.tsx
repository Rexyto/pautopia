    ...
    <Layout>
      ...
      <main className="biblioteca-content container">
        <div className="biblioteca-header">
          ...
          <h2 className="biblioteca-title">Tecnología e Ingeniería II</h2>
          <p className="biblioteca-subtitle">
            Apuntes y recursos de estudio técnico-industrial
          </p>
        ...
        <div className="lengua-sections">
          <section className="lengua-section">
            <h3 className="section-category-title">Ingeniería Técnico-Industrial II</h3>
            <div className="resource-cards-grid">
              <div className="resource-card">
                <div className="resource-card-header">
                  <h4 className="resource-card-title">Tecnología Industrial II</h4>
                </div>
                <button
                  onClick={() => downloadFile('/tecno-industrial-II.pdf')}
